...
try {
    ...
    $areas = $areaModel->obtenerTodasAreas();
    $municipios = $municipioModel->obtenerTodosMunicipios();
    $tiposVinculacion = $tipoVinculacionModel->obtenerTodosTipos();
...
<head>
    ...
    <link rel="stylesheet" href="../styles/edita_contratista.css">
</head>
<body>
