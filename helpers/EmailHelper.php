...
class EmailHelper {
    ...
    // Función para enviar correo de contrato vencido (por si la necesitas después)
    public static function enviarCorreoContratoVencido($correoDestino, $nombreContratista, $fechaVencimiento) {
        // Similar estructura para notificar vencimiento de contrato
        // Puedes implementarla cuando necesites
        return true;
    }
}
?>