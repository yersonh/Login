...
class ConfiguracionControlador {
    ...
    public function actualizarLogo(string $rutaLogo, string $entidad, string $enlaceWebm, string $nit): bool {
        return $this->modelo->actualizarLogoYDatos($rutaLogo, $entidad, $enlaceWeb, $nit);
    }
