...
<body>
    <div class="container">
        <div class="left">
            <h1><span class="titulo-sgea">HMS Modulo de medición de <br>desempeño, tareas y compromisos</span></h1>
        ...
        <div class="right">
            ...
            <form method="POST" action="" id="loginForm" autocomplete="on">
                ...
                <div class="quienesSomos">
                    <a href="https://sistema-de-gestion-administrativo-v1-1.webnode.com.co/" target="_blank">¿Que es SGA - Sistema de Gestión Administrativo?</a>
                </div>
            </form>
        </div>
    </div>
